<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_keyword.aspx.cs" Inherits="online_examination_system.WebForm10" %>
        ...
        <!----------------------------------2nd row----------------------------------->
         ...
         <div class="container" width="100%">
            ...
            <div class="row" style="width: 100%;">
                <center>
                    <div class="container" style="background-color: #000000c7; width: 50%;">
                        <div class="row" style="height: 10px; width: 100%;"></div>
                        <div class="row" style="height: 10px; width: 100%;">
                            <center>
                                <h1 style="color: white;">Add New Keyword</h1>
                            </center>
                        </div>
                        ...
                        <div class="row" style="height: 50px; width: 100%;">
                            <label style="color: white;">Keyword Id</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                        </div>
                        <div class="row" style="height: 10px; width: 100%;"></div>
                        <div class="row" style="height: 50px; width: 100%;">
                            <label style="color: white;">New Keyword</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
