<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="change_password.aspx.cs" Inherits="online_examination_system.WebForm9" %>
                ...
                <center>
                    <div class="container" style="background-color: #904906b0; width: 50%;">
                        ...
                        <div class="row" style="height: 150px; width: 100%;">
                            <center>
                                <image url="images//6.jpg" style="background-image: url(images//6.jpg); border-radius: 121px; border: 2px black; height: 169px; width: 173px;"></image>
