<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_qa.aspx.cs" Inherits="online_examination_system.WebForm12" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title> add que and ans</title>
        ...
        <!----------------------------------2nd row----------------------------------->
         ...
         <div class="container" width="100%">
            ...
            <div class="row" style="width: 100%;">
                <center>
                    <div class="container" style="background-color: #000000c2; width: 50%;">
                        <div class="row" style="height: 10px; width: 100%;"></div>
                        <div class="row" style="height: 10px; width: 100%;">
                            <center>
                                <h1 style="color: white;">Add Question And Answer</h1>
                            </center>
                        </div>
                        ...
                        <div class="row" style="height: 50px; width: 100%;">
                            <label style="color: white;">Question Id</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                        </div>
                        <div class="row" style="height: 10px; width: 100%;"></div>
                        <div class="row" style="height: 50px; width: 100%;">
                            <label style="color: white;">New Question</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
