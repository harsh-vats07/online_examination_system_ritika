<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_result.aspx.cs" Inherits="online_examination_system.WebForm13" %>
                ...
                <center>
                    <div class="container" style="background-color: #00000099; width: 50%;">
                        ...
                        <div class="row" style="height: 10px; width: 100%;">
                            <center>
                                <h1 style="color: white;">VIEW RESULT</h1>
                            </center>
                        </div>
